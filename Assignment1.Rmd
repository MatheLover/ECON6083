...
IVmodel <- ivreg(yi~di | data.frame.iv[,1:5],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_2 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:10],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_3 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:15],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_4 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:20],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_5 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:25],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_6 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:30],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_7 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:35],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_8 <- iv_di_coef[2,2]

IVmodel <- ivreg(yi~di | data.frame.iv[,1:40],data=data.frame.iv)
iv_di_coef <- summary(IVmodel)$coefficients 
di_9 <- iv_di_coef[2,2]
