...
summary(reg_b)
```
The standard error and p-value on the coefficient of Di are 0.42435 and 0.00265 respectively.  
...
The standard error and p-value on the coefficient of Di are 10.5245 and 0.312 respectively.
...
avg_SE_ctrl
```
The average SE for OLS estimator on Di when the controls are excluded is 0.4513832.
The average SE for OLS estimator on Di when the controls are included is 11.33974. 
...
```
The fraction of MC repetitions in which the OLS estimators are significant when we exclude controls is 0.579.
The fraction of MC repetitions in which the OLS estimators are significant when we include controls is 0.053.
