...
rownames(sim_1_result_df) <- c("Lasso including the first regressor (lambda1)",
                               "Lasso inclduing at least one of the irrelevant regressors (lambda1)",
                               "Lasso including the first regressor (lambda2)",
                               "Lasso inclduing at least one of the irrelevant regressors (lambda2)",
                               "Lasso including the first regressor (lambda3)",
                               "Lasso inclduing at least one of the irrelevant regressors (lambda3)",
                               "Lasso including the first regressor (lambda4)",
                               "Lasso inclduing at least one of the irrelevant regressors (lambda4)"
                               )
sim_1_result_df %>%
